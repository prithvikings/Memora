    ...
    <div className="max-w-6xl mx-auto py-24 px-4 md:px-0">
      ...
      >
        <motion.h1
          ...
          className="text-4xl md:text-5xl font-poppins tracking-tight"
        >
          Built for people <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
          ...
          >
            <div className="bg-neutral-200 h-48 rounded-xl w-full">
              <Developers />
            </div>
            <div className="flex flex-col gap-2">
              <h2 className="text-xl font-poppins text-neutral-800">
                Developers
              </h2>
      ...
      >
        <motion.h1
          variants={itemVariants}
          className="text-center text-4xl font-poppins tracking-tight"
        >
        ...
        <div className="grid grid-cols-3 gap-4 mt-16 justify-items-center bg-white border border-neutral-100 shadow-sm rounded-3xl p-8 md:p-12">
          ...
          <motion.div
            variants={itemVariants}
            className="flex flex-col gap-8 items-center w-full bg-neutral-50 rounded-2xl py-4 -my-4"
          >
          ...
          <motion.div
            variants={itemVariants}
            className="flex flex-col gap-8 items-center w-full bg-neutral-900 text-white rounded-2xl py-4 -my-4 shadow-lg"
          >
            <h2 className="text-xl font-medium text-white mb-2 font-gist">
              Memora
            </h2>
            <div className="h-6 flex items-center">
              <Check />
