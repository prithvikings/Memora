...
const features = [
  {
    title: "AI Summaries",
    description: "Get concise summaries of your bookmarks, so you can quickly understand the content without having to open the link."
  },
  {
    title: "Smart Tags",
    description: "Automatically categorize your saved links with AI-generated tags based on the actual content of the page."
  },
  {
    title: "Semantic Search",
    description: "Find exactly what you're looking for by searching for concepts and ideas, not just exact keywords."
  },
  {
    title: "Automatic Metadata",
    description: "Pull in authors, publish dates, and hero images automatically to keep your library visually organized."
  },
  {
    title: "Collections",
    description: "Group related links together into smart folders that update automatically as you save new content."
  }
];
    ...
    <div ref={containerRef} className='relative h-[400vh]'>
      ...
      <div className='sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden'>
        ...
        <div className='w-full max-w-6xl mx-auto px-6'>
          ...
          >
            Powerful Features Designed <br className="hidden md:block" /> for Knowledge Hoarders
          </motion.h1>
            ...
            >
                <AnimatePresence mode="wait">
                    <motion.div
                        ...
                        className="absolute inset-0 bg-gradient-to-br from-neutral-200 to-neutral-300 flex items-center justify-center text-neutral-400 font-medium text-xl text-center px-4"
                    >
                        {features[activeIndex].title} UI Image
                    </motion.div>
                </AnimatePresence>
            </motion.div>
            ...
            <div className='w-full md:w-3/5 flex flex-col items-start justify-center gap-3'>
              {features.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    {/* Accordion Title */}
                    <h1 className={`text-xl font-medium transition-colors duration-500 ${
