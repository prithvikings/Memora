  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="links flex items-center gap-8 font-light text-sm text-white"
      >
      ...
      <motion.div variants={itemVariants}>
        <button
          onClick={handleclick}
          className="text-sm px-4 py-2 bg-white rounded-full text-black font-medium hover:scale-105 transition-transform duration-300"
        >
          Get Started
        </button>
      </motion.div>
