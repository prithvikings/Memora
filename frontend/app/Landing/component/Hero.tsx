    ...
    <div className='mx-auto max-w-6xl'>
      <div className='flex items-center gap-8 mt-32'>
        <div className='flex items-center justify-center flex-col max-w-4xl mx-auto space-y-2'>
          <h1 className='text-6xl font-instrument text-center leading-tight'>Turn Your Bookmarks Into an <br />AI-Powered Knowledge Hub</h1>
          <p className='text-sm mt-4 text-gray-600 max-w-md text-center'>Save any webpage and let AI automatically summarize, organize, and make it searchable.</p>
