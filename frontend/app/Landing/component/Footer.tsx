...
const footerLinks = [
  {
    title: "Product",
    links: ["Features", "Pricing", "Use Cases", "Browser Extension", "Changelog"],
  },
  {
    title: "Resources",
    ...
    <footer className="bg-[#1C1C1C] text-[#A3A3A3] py-24 px-6 md:px-12 font-sans w-full border-t border-white/5">
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-16 lg:gap-8 mb-24">
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-2 md:grid-cols-3 gap-x-12 gap-y-12">
        ...
        >
          <div className="flex flex-col gap-2">
            <h1 className='text-2xl font-medium text-white font-gist'>Memora</h1>
