...
const scrollFeatures = [
  { id: 0, title: "Bookmark card with summary", mockupText: "Dashboard Mockup UI" },
  { id: 1, title: "Tag system", mockupText: "Tagging System UI" },
  { id: 2, title: "Search UI", mockupText: "Semantic Search UI" },
  { id: 3, title: "Collections dashboard", mockupText: "Folders & Collections UI" },
];
...
const Cleaner = () => {
  ...
  return (
    ...
    <div ref={containerRef} className="relative h-[400vh] py-16  w-full bg-neutral-100/50">
      {/* Header */}
          <motion.h1 
          ...
          <div className='relative w-full bg-zinc-200 h-[400px] md:h-[550px] rounded-2xl shadow-sm border border-black/5 overflow-hidden'>
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-zinc-200 to-zinc-300"
              >
                {/* Replace this with your actual next/image components later */}
                <h2 className="text-2xl text-zinc-500 font-medium">
                  {scrollFeatures[activeIndex].mockupText}
                </h2>
              </motion.div>
            </AnimatePresence>
          </div>
